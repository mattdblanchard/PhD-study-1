...
reliability_codrive <- bind_rows(res, ipip, fluid, conf, bias, discrim, switch_errors, switch_time, switch_cost, wm_acc, flank_errors, flank_time, flank_cost) %>% 
  rename(a_codrive = rel)
  # write_csv("output/reliability_codriver.csv")
