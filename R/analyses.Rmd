...
#   theme_classic()
# 
# p <- plot_grid(a,b,c, ncol = 2, labels = c("A", "B", "C"), 
#                label_fontface = "bold", label_size = 12)
# 
# ggsave(here("output/sim_metric_distributions.png"))
...
x <- vars %>% 
  select(sim_metrics, comms_fac, age_co_driver:sex_driver, prop_female, driving_years:neuroticism, driving_years_drone:neuroticism_drone, -contains("aus_years"), -contains("dic_use"))
